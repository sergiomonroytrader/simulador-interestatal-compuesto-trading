...
def simulate_trades(initial_balance, trades=40, risk=0.06, rr_ratio=2):
    balance = initial_balance
    results = []
    
    # Orden específico de operaciones para alcanzar un resultado cercano a 10X
    outcomes = [
        "win", "lose", "win", "win", "lose", "win", "win", "win", "lose", "win",
        "win", "win", "lose", "win", "win", "win", "lose", "win", "win", "win",
        "lose", "win", "win", "lose", "win", "win", "win", "lose", "win", "win",
        "win", "lose", "win", "win", "win", "lose", "win", "win", "win", "lose"
    ]  # Patrón ajustado para llegar a un 10X aproximado (400$ desde 40$)
